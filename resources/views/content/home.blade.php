		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-2 col-md-8">
                    ...
                    <br>
					<a data-scroll href="{{ route('login') }}" class="btn" data-wow-offset="50" data-wow-delay="0.6s">Iniciar Sesión</a>
					<a data-scroll href="{{ route('registro') }}" class="btn"  data-wow-offset="50" data-wow-delay="0.6s">Registro</a>
				</div>
			</div>
		</div>
	</section>
	...
	<!--<section id="portfolio">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
                    <div class="col-md-12">
                        <h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s"><span>SALESTECH</span> PRODUCTOS
                        </h2>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="0.6s">
                        <div class="portfolio-thumb">
                            <img src="images/Img_Brown.jpg" class="img-responsive" alt="portfolio img 1">
                            <div class="portfolio-overlay">
                                <h4>SALESTECH</h4>
                                <p>Lenovo IdeaCentre AIO 3i Computadora Todo en uno de 24 Pulgadas, Intel Core i5-10400T, Pantalla FHD, 16 GB de RAM, 1 TB HDD, 256 GB SSD, DVD RW, Windows 10</p>
                            </div>
                        </div>
                    </div>
                   <div class="col-md-3 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="0.6s">
                        <div class="portfolio-thumb">
                            <img src="images/Img_Brown3.png" class="img-responsive" alt="portfolio img 2">
                            <div class="portfolio-overlay">
                                <h4>SALESTECH</h4>
                                <p>HP ProDesk 600 G1 SFF Slim Business computadora de computadora, Intel i5-4570 hasta 3,60 GHz, 8 GB RAM, 500 GB HDD, DVD, USB 3.0, Windows 10 Pro 64 bit (8 GB RAM, 500 GB HDD)(Reacondicionado)</p>
                            </div>
                        </div>
                    </div>
                </div>
